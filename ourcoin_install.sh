...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ourcoin.conf'
CONFIGFOLDER='/root/.ourcoin'
COIN_DAEMON='ourcoind'
COIN_CLI='ourcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ="https://github.com/ourcoin1/OurCoin/releases/download/v1.0.0.0/OurCoin-v1.0.0.0-linux64.tar.gz"
